...
class CartController extends FrontBaseController
{
    ...
    public function addcart($id)
    {
        ...
        $prod = Product::where('id', '=', $id)->first(['id',  'slug', 'name', 'photo', 'size', 'size_qty', 'size_price', 'color', 'price', 'stock', 'type', 'file', 'link', 'license', 'license_qty', 'measure', 'whole_sell_qty', 'whole_sell_discount', 'attributes', 'size_all', 'color_all']);
