...
class CheckoutController extends FrontBaseController
{
    ...
    public function checkout()
    {
        ...
        if (Auth::check()) {
            ...
            return view('frontend.checkout', ['products' => $cart->items, 'totalPrice' => $total, 'pickups' => $pickups, 'totalQty' => $cart->totalQty, 'gateways' => $gateways, 'shipping_cost' => 0, 'digital' => $dp, 'curr' => $curr, 'shipping_data' => $shipping_data, 'package_data' => $package_data,  'paystack' => $paystackData]);
        } else {
