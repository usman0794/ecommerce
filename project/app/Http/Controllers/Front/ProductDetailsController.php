...
class ProductDetailsController extends FrontBaseController
{
    ...
    public function product(Request $request, $slug)
    {
        ...
        $recent_products =  $recent_products = Product::where('status', '=', 1)->orderBy('id', 'desc')
            ->withCount('ratings')
        ...
        return view('frontend.product', compact('productt', 'curr', 'affilate_user', 'recent_products'));
    }
