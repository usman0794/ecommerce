...
<html lang="en">
							   ...
							   <div class="row">
								  <div class="col-lg-12 mt-3">
									 <div class="bottom-area">
										<input type="hidden" value="<?php echo e($order->pay_amount * $order->currency_value); ?>" id="grandTotal">
					  ...
					  <div class="order-box">
						 ...
						 <div class="total-price">
							...
							<p>
							   ...
							   <?php else: ?> 
							   <span id="total-cost"> <span class="total_price"> <?php echo e($order->pay_amount * $order->currency_value); ?></span><?php echo e($order->currency_sign); ?></span>
							   <?php endif; ?>
							</p>
						 </div>
						 ...
						 <div class="packeging-area">
							...
							<div class="radio-design">
							   <input type="radio" class="shipping" id="free-shepping<?php echo e($data->id); ?>" name="shipping" value="<?php echo e($data->id); ?>" data="<?php echo e(round($data->price * $order->currency_value,2)); ?>" <?php echo e(($loop->first) ? 'checked' : ''); ?>> 
							   <span class="checkmark"></span>
							   <label for="free-shepping<?php echo e($data->id); ?>"> 
							   <?php echo e($data->title); ?>

							   <?php if($data->price != 0): ?>
							   + <?php echo e($order->currency_sign); ?><?php echo e(round($data->price * $order->currency_value,2)); ?>
						 ...
						 <div class="packeging-area">
							...
							<div class="radio-design">
							   <input type="radio" class="packing" id="free-package<?php echo e($data->id); ?>" name="packeging" value="<?php echo e($data->id); ?>" data="<?php echo e(round($data->price * $order->currency_value,2)); ?>" <?php echo e(($loop->first) ? 'checked' : ''); ?>> 
							   <span class="checkmark"></span>
 ...
 </script><?php /**PATH /home/demoroyal/public_html/test/online_store_api/project/resources/views/payment/checkout.blade.php ENDPATH**/ ?>